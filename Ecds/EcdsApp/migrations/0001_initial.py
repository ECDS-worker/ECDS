# Generated by Django 2.1.2 on 2018-12-10 13:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_ccpc', models.CharField(default='', help_text='生产CCPC', max_length=32)),
                ('test_ccpc', models.CharField(default='', help_text='测试CCPC', max_length=48, null=True)),
                ('test_num', models.CharField(default='', help_text='测试环境接入点号', max_length=48, null=True)),
                ('product_num', models.CharField(default='', help_text='生产环境接入点号', max_length=48, null=True)),
                ...
                ('check_nm', models.CharField(default='', help_text='审核人', max_length=20)),
                ('support_name', models.CharField(default='', help_text='ECDS支持人员信息', max_length=16, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aply_info', models.ForeignKey(help_text='机构信息表', on_delete=django.db.models.deletion.CASCADE, to='EcdsApp.ApplyInfo')),
            ],
            options={
                'verbose_name': '前置机信息表',
